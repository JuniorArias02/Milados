				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{categorias.flatMap(cat =>
						cat.productos.map(p => (
							...
							>
								{/* Contenedor de imagen con altura proporcional */}
								<div className="overflow-hidden relative flex-grow-0">
									{p.imagen ? (
										<img
											src={p.imagen}
											alt={p.nombre}
											className="w-full h-auto max-h-64 object-cover transition-transform duration-500 hover:scale-105"
										/>
									) : (
										<div className="w-full h-48 bg-gradient-to-br from-[#FF73D9]/10 to-[#83CCDA]/20 flex items-center justify-center">
								...
								{/* Contenido de la tarjeta con flex-grow para altura variable */}
								<div className="p-6 flex flex-col flex-grow">
									...
									{/* Características con iconos - ahora con altura flexible */}
									<div className="grid grid-cols-2 gap-2 mb-4 flex-grow">
										...
										{/* Espacio flexible para descripciones adicionales si las hay */}
										{p.descripcion && (
									...
									<button className="w-full py-3 rounded-lg quicksand-semibold text-white bg-[#FF73D9] hover:bg-[#e65ac4] transition-colors flex items-center justify-center mt-auto cursor-pointer">
